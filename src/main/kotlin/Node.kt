...
val BinaryEncoderObjects = listOf(StringBinaryEncoder::class, IntBinaryEncoder::class, ByteArrayBinaryEncoder::class)
val ConcreteAndEnumClasses = listOf(FileNode::class, DirectoryNode::class)
